...
import { ArrowRight, Plus, Save, Star } from "lucide-react";
      ...
      <section className="mb-8">
        ...
        <div className="mt-5">
          ...
          <p
            ...
            "
          >
            أنشئ مقالًا جديدًا في Kometik Journal
            واربطه بالمنتجات المناسبة.
          </p>
        </div>
      </section>
            ...
            <div className="kometik-space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="مثال: ما هو حمض الهيالورونيك؟"
                  className="
                    w-full
                    rounded-xl
                    border
              ...
              <div>
                ...
                <input
                  ...
                  dir="ltr"
                  required
                  placeholder="what-is-hyaluronic-acid"
                  className="
                    w-full
                    rounded-xl
                    border
              ...
              <div>
                ...
                <textarea
                  ...
                  name="excerpt"
                  rows={4}
                  placeholder="اكتب مقدمة قصيرة تظهر في صفحة الـJournal..."
                  className="
                    w-full
                    resize-y
                    rounded-xl
            ...
            <div className="kometik-space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="seoDescription"
                  rows={4}
                  placeholder="وصف قصير للمقال يظهر في نتائج البحث..."
                  className="
                    w-full
                    resize-y
                    rounded-xl
          ...
          >
            <div className="mb-5">
              ...
              <p
                ...
                "
              >
                اختر صورة المقال وسيتم رفعها عبر
                Cloudinary.
              </p>
            </div>
          ...
          >
            <div className="mb-5">
              ...
              <p
                ...
                "
              >
                اختر المنتجات التي تريد ظهورها داخل
                المقال.
              </p>
            </div>
